                            ...
                            while ($Count >= $i) {
                                ...
                                <div class="swiper-slide">
                                    <div class="text-center">
                                        <img src="<?php echo $logo; ?>" class="img-fluid <?php echo $class; ?>" width="125" height="125" alt="financing-affiliate-logo" srcset="<?php echo $logo; ?> 1x, <?php echo $logo2x; ?> 2x, <?php echo $logo3x; ?> 3x," />
                                    </div>
                                </div>
                                <?php $i++;
                            }
