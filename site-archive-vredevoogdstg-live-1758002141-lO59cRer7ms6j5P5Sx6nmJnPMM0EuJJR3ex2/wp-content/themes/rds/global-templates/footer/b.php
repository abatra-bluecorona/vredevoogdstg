   ...
   <div class=" footer_copyright_bar text-center text-lg-start  font_alt_1 mb-lg-0 mb-5 pt-1 pb-3 pt-lg-4 pb-lg-4">
      <div class="container py-lg-1 pb-3  p-alt  line_height_30   font_alt_1  text_normal  text_16 px-0  ">
         <i class="p-alt icon-copyright4   text_16  line_height_28  "></i> <?php echo date(
            ...
            if (!empty($args["site_info"]["bluecorona_branding"])) { ?><span class="d-none d-sm-inline-block  line_height_30  font_alt_1  text_normal  text_16 d-lg-inline-block">&nbsp;|&nbsp;</span><span class="d-block d-sm-inline-block d-lg-inline-block  p-alt ">Web Design by&nbsp;&nbsp;</span><?php }
            ?>
         ...
         //echo $args["site_info"]["bluecorona_link"]; ?>"><img src="<?php echo get_exist_image_url(
               "footer",
               "bc-logo"
           ); ?>" width="19" height="20" <?php echo $copyright_svg_alt; ?>>&nbsp;&nbsp;Blue Corona</a><span class="d-none d-sm-inline-block d-lg-inline-block d-none">&nbsp; | &nbsp;</span><a class=" footer_copyright_links  a-alt  copyright_hover"  href="#" data-bs-toggle="modal" data-bs-target="#disclaimer">Disclaimer</a><span class="d-inline-block">&nbsp; | &nbsp;</span><a class=" footer_copyright_links  a-alt copyright_hover" href="<?php echo get_home_url() .
