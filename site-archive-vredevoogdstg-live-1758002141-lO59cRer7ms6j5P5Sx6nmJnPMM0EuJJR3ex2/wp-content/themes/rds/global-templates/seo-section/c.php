        ...
        if ($elementorData) {
            ...
            if (isset($array_data[0]["elements"][0]["elements"][0]["settings"]["template_id"])) {
                ...
                if ($template_id == 40758) {
                    ...
                    $a = '<img src="' . $image_placeholder_image . '" srcset="' . $image_placeholder_image . ' 1x, ' . $image_placeholder_image2x . ' 2x, ' . $image_placeholder_image3x . ' 3x" class="img-fluid float-lg-start me-lg-5 pb-lg-0 pb-4 d-lg-inline-block d-none" width="540" height="534" alt="Homepage Image">
                    <img src="' . $image_placeholder_image . '" srcset="' . $image_placeholder_image . ' 1x, ' . $image_placeholder_image2x . ' 2x, ' . $image_placeholder_image3x . ' 3x"  class="img-fluid float-lg-start me-lg-5 pb-lg-0 pb-4 d-inline-block d-lg-none" width="540" height="534" alt="Homepage Image">';
                }
            }
        }
    }
...
?>
<div class="d-block">
    <div class="container-fluid py-lg-0 py-2 pt-lg-3 text-start">
        <div class="container pt-lg-3 py-0">
            <div class="row py-lg-2">
                <div class="col-lg-12 px-0 bc_homepage seosection-bc text-md-left seotext-sm-center">
                    ...
                    if ($postId == 40758) {
                    ?>
                        <img src="<?php echo !empty(get_exist_image_url("about-page", "about-img")) ? get_exist_image_url("about-page", "about-img") : ''; ?>" srcset="<?php echo !empty(get_exist_image_url("about-page", "about-img")) ? get_exist_image_url("about-page", "about-img") . ' 1x, ' . get_exist_image_url("about-page", "about-img@2x") . ' 2x, ' . get_exist_image_url("about-page", "about-img@3x") . ' 3x' : ''; ?>" class="img-fluid float-lg-start me-lg-5 pb-lg-0 pb-4" width="540" height="534" alt="Homepage Image">
                    <?php
                    } else {
                    ?>
                        <img src="<?php echo !empty(get_exist_image_url("seo-section", "seo-img")) ? get_exist_image_url("seo-section", "seo-img") : ''; ?>" srcset="<?php echo !empty(get_exist_image_url("seo-section", "seo-img")) ? get_exist_image_url("seo-section", "seo-img") . ' 1x, ' . get_exist_image_url("seo-section", "seo-img@2x") . ' 2x, ' . get_exist_image_url("seo-section", "seo-img@3x") . ' 3x' : ''; ?>" class="img-fluid float-lg-start me-lg-5 pb-lg-0 pb-4" width="540" height="534" alt="Homepage Image">
                    <?php
                    }
                    ?>
