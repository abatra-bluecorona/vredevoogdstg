                ...
                <div class="col-lg-5 col-sm-7 text-center pb-md-0 pb-5 mb-md-0 mb-5">
                    <div class="d-block px-xl-4 px-4 py-4 py-lg-5 true_white_bg shadow-md mb-md-0 mb-5">
                        ...
                        <?php if (!empty($heading)) : ?>
                            <?php if ($heading != strip_tags($heading)) : ?>
                                <span class="pt-lg-4 pb-3 mb-0"><?php echo $heading; ?></span>
                            <?php else : ?>
                        ...
                        <?php if (!empty($description_html_allowed)) : ?>
                            <?php if ($description_html_allowed != strip_tags($description_html_allowed)) : ?>
                                <span class="mb-2"><?php echo $description_html_allowed; ?></span>
                            <?php else : ?>
