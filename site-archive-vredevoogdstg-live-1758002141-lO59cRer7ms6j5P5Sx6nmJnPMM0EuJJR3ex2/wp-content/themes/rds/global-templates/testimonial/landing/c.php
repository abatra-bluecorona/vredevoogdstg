                ...
                <div class="row">
                    <div class="col-lg-6 pt-4 pt-lg-0 d-lg-block d-none">
                        <img src="<?php echo get_exist_image_url("testimonial", "reviews-img"); ?>" 
                             ...
                             alt="Review Image" width="540" height="542" class="img-fluid pl-3 h-100">
                    </div>
                    <div class="col-lg-6">
                        ...
                        <div class="text-lg-start text-center pb-lg-0 pb-4 mb-3 mb-lg-0">
                            <a href="<?php echo get_home_url() . $args["globals"]["testimonial"]["button_link"]; ?>" 
                               class="btn btn-primary" 
                               target="<?php echo isset($args["globals"]["testimonial"]["is_external"]) ? $args["globals"]["testimonial"]["is_external"] : false; ?>">
                                <?php echo $args["globals"]["testimonial"]["button_text"]; ?>
                            </a>
                        </div>
                        <?php endif; ?>
