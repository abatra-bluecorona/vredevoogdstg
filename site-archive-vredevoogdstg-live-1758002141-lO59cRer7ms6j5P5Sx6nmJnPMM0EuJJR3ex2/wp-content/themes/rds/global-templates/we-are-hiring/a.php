        ...
        <div class="container py-lg-3 py-5">
            <div class="row align-items-center py-lg-0 py-2">
                ...
                <div class="col-sm-12 col-lg-6 text-center text-lg-start py-lg-0 py-4">
                    <h6 class=""><?php echo !empty($args["page_templates"]["homepage"]["we_are_hiring"]["heading"]) ? esc_html($args["page_templates"]["homepage"]["we_are_hiring"]["heading"]) : ''; ?></h6>
                    <h4 class="mt-2 mb-0 d-block"><?php echo !empty($args["page_templates"]["homepage"]["we_are_hiring"]["subheading"]) ? esc_html($args["page_templates"]["homepage"]["we_are_hiring"]["subheading"]) : ''; ?></h4>
                </div>
