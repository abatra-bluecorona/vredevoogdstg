...
public $widgetPathFull;
    ...
    public function __construct($data = [], $args = null)
    {
        ...
        $this->widgetPath = "about-us/meet-the-team";
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section("rds_global_aboutmeet_widget", [
        ...
        if (!empty($this->allVariation) && count($this->allVariation) > 1) {
            $defaultVariation = isset($args["page_templates"]["about_us_page"]["meet_the_team"]["variation"]) 
            ? $args["page_templates"]["about_us_page"]["meet_the_team"]["variation"] : "a";
