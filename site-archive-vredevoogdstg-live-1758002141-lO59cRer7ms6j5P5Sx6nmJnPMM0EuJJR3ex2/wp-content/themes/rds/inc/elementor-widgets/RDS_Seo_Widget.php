...
class RDS_Seo_Widget extends Widget_Base
{
	...
	protected function render()
	{
		...
		$args["page_templates"]["history_page"]["seo_section"]["heading"] = sanitize_text_field($settings["heading"]);
		$args["page_templates"]["history_page"]["seo_section"]["subheading"] = sanitize_text_field($settings["subheading"]);
		...
		$args["page_templates"]["about_us_page"]["seo_section"]["heading"] = sanitize_text_field($settings["heading"]);
		$args["page_templates"]["about_us_page"]["seo_section"]["subheading"] = sanitize_text_field($settings["subheading"]);
		...
		$args["page_templates"]["landing_page"]["seo_section"]["heading"] = sanitize_text_field($settings["heading"]);
		$args["page_templates"]["landing_page"]["seo_section"]["subheading"] = sanitize_text_field($settings["subheading"]);
