...
class RDS_Subpagesidebar_Widget extends Widget_Base
{
    ...
    public function __construct($data = [], $args = null)
    {
        ...
        $this->widgetPath = "subpage-hero/subpage-sidebar";
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section("rds_global_subpagesidebar_widget", [
        ...
        if (!empty($this->allVariation) && count($this->allVariation) > 1) {
            $defaultVariation = isset($args["page_templates"]["subpage"]["sidebar"]["banner"]["variation"]) ? $args["page_templates"]["subpage"]["sidebar"]["banner"]["variation"] : "a";
