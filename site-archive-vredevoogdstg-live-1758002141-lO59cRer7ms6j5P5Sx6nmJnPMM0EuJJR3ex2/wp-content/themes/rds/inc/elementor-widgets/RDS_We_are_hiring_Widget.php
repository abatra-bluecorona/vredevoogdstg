...
public $widgetPathFull;
    ...
    public function __construct($data = [], $args = null)
    {
        ...
        $this->widgetPath = "we-are-hiring"; //Edit
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section("rds_global_company_service_widget", [
            "label" => esc_html__("Global We Are Hiring Widget", "rds-global-we-are-hiring-widget"),
        ]);
        if (!empty($this->allVariation) && count($this->allVariation) > 1) {
            $defaultVariation = isset($args["page_templates"]["homepage"]["we_are_hiring"]["variation"]) ? $args["page_templates"]["homepage"]["we_are_hiring"]["variation"] : "a";
