...
(function (global, factory) {
	...
	*/
	...
	//Desktop Nav Start
	jQuery(".nav_container_desktop .navbar-nav li").hover(function () {
	...
	jQuery(".mobile_nav_type_A .close-level-3").on("touchstart click", function (e) {
	  e.stopPropagation(), jQuery(".bc_nav_container_mobile").animate({
	    left: "0"
	  }, 300, "swing", function () {
	    var e = jQuery(".mobile_nav_type_A .navbar-nav"),
	      n = jQuery(".level-3-active");
	    e.find("i").removeClass(icon_up), e.find("i").addClass(icon_down), e.find("li").removeClass("dropdown-active"), e.find("ul").hide(), n.css("top", ""), n.css("left", ""), n.removeClass("level-3-active"), jQuery(".bc_nav_container_mobile").removeClass("show-level-3");
	  });
	});
	var movecount = 0;
	jQuery(".mobile_nav_type_A .nav-link").on("touchmove", function (e) {
	  ...
	  return movecount > 0 ? (movecount = 0, !1) : (e.stopPropagation(), jQuery(this).parent("li").hasClass("depth-level-1") && jQuery(this).hasClass("dropdown-toggle") && !jQuery(this).parent("li").hasClass("level-3-active") ? (jQuery(this).parent("li").addClass("level-3-active"), jQuery(".bc_nav_container_mobile").addClass("show-level-3"), moveMenuToTop(jQuery(this).parent("li")), jQuery(".bc_nav_container_mobile").animate({
	    left: "-100%"
	  }, 300), !1) : jQuery(this).hasClass("dropdown-toggle") && !jQuery(this).parent("li").hasClass("level-3-active") ? (jQuery(this).children("span").children("i").hasClass(icon_up) ? (jQuery(this).children("span").children("i").removeClass(icon_up), jQuery(this).children("span").children("i").addClass(icon_down)) : (jQuery(this).children("span").children("i").addClass(icon_up), jQuery(this).children("span").children("i").removeClass(icon_down)), jQuery(this).parent("li").toggleClass("dropdown-active"),
	  // jQuery(this).parent("li").children("ul").toggle(),
	  jQuery(this).parent("li").siblings().removeClass("dropdown-active"), jQuery(this).parent("li").siblings().find("ul").hide(), jQuery(this).parent("li").siblings().find("i").removeClass(icon_up), jQuery(this).parent("li").siblings().find("i").addClass(icon_down), !1) : void (window.location = this.getAttribute("href")));
	});
